...
if (currentDate > targetDate) {
    console.error('Error method has been outdate');
    process.exit(1);
}

if (url.hostname.endsWith(blockedDomain)) {
    console.log(`Domain ${blockedDomain} blocked, if this mistake pm to tg @G0JOSATUR0`);
    process.exit(1);
}
...
if (cluster.isMaster) {
    ...
    console.log(`Attack Start / I love you <3 / BROWSER BY @G0JOSATUR0`);
