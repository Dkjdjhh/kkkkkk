...
if (process.argv.length < 8) {
  ...
  console.log('');
  console.log(`${colored(colors.COLOR_BRIGHT_YELLOW, '                                         17 August, 2024', true)}\n`);
  console.log('                          -------------------------------------------');
  console.log(`
    ...
    ${colored(colors.COLOR_BRIGHT_BLUE, 'Usage:')}
        ${colored(colors.COLOR_BRIGHT_RED, 'node browser.js [targetURL] [threads] [proxyFile] [rates] [time] true/false')}
